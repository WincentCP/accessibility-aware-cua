"""FastAPI entry point for the research runtime and controlled mini-sites."""
...
from backend.agent.gemini_tts import GeminiTTSClient, GeminiTTSQuotaError
from backend.agent.live import LiveAgentManager
from backend.api import APP_VERSION
from backend.api.config import ROOT, ConfigurationError, Settings
from backend.api.store import CaseStore, InvalidAction, SessionNotFound
from backend.api.study import StudySessionStore
from backend.api.study_report import build_study_report

FRONTEND_DIR = ROOT / "frontend" / "research-console"
